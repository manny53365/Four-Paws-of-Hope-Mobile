...
interface SignupPayload {
  ...
  phone: string
  address: string
  pfp: string | null // For React Native, we'll use URI string instead of File
}
...
const signup = async ({
  ...
  try {
    ...
    // Optional profile picture - for React Native, we need to fetch and convert URI to blob
    let uploadPath: string | null = null
    let photoURL: string | null = null

    if (pfp) {
      uploadPath = `profilePictures/${res.user.uid}/${Date.now()}`
